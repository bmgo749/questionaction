            ...
            <CardContent>
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Button variant="outline" className="w-full" onClick={() => window.location.href = 'https://discord.com/oauth2/authorize?client_id=1344311791177564202&response_type=code&redirect_uri=https%3A%2F%2Fkaiserliche.my.id&scope=identify+email'}>
